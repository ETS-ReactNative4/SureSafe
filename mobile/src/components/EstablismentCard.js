...
export const EstablismentCard = ({data}) => {
  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.textBox}>
        ...
        <Text style={[Fonts.BODY, {fontSize: 15}]}>
          {data?.municipality}, {data?.barangay}
        </Text>
        <Text style={[Fonts.BODY, {fontSize: 15}]}>0{data?.number}</Text>
        <Text style={[Fonts.BODY, {fontSize: 15}]}>{dateString}</Text>
      </View>
